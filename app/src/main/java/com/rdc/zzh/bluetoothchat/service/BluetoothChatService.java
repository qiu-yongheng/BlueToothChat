...
public class BluetoothChatService {
    ...
    private int mState;
    // 显示当前连接状态
    private static final int STATE_NONE = 0;       // 什么都不做
    private static final int STATE_LISTEN = 1;     // 监听连接
    private static final int STATE_CONNECTING = 2; // 正在建立连接
    private static final int STATE_TRANSFER = 3;  // 现在连接到一个远程的设备，可以进行传输
    ...
    //获取单例
    private static volatile BluetoothChatService instance = null;
    ...
    /**
     * 客户端连接服务端 (socket连接serviceSocket)
     */
